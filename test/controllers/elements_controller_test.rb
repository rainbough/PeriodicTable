...
class ElementsControllerTest < ActionController::TestCase
  ...
  test "should create element" do
    assert_difference('Element.count') do
      post :create, element: { name: @element.name, number: @element.number, symbol: @element.symbol, weight: @element.weight }
    end
  ...
  test "should update element" do
    patch :update, id: @element, element: { name: @element.name, number: @element.number, symbol: @element.symbol, weight: @element.weight }
    assert_redirected_to element_path(assigns(:element))
  end
